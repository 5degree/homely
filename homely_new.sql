...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 26, 2021 at 04:51 AM
...
--
-- Table structure for table `home_companykyc`
--

CREATE TABLE `home_companykyc` (
  `id` int(11) NOT NULL,
  `name` varchar(50) NOT NULL,
  `company` varchar(50) NOT NULL,
  `email` varchar(50) NOT NULL,
  `social_channels` longtext NOT NULL,
  `hq` varchar(100) NOT NULL,
  `team_size` varchar(50) NOT NULL,
  `home_page` varchar(50) NOT NULL,
  `source_of_funds` varchar(1000) NOT NULL,
  `foundedDate` date NOT NULL,
  `city` varchar(150) NOT NULL,
  `state` varchar(150) NOT NULL,
  `country` varchar(150) NOT NULL,
  `accredited_doc` varchar(100) DEFAULT NULL,
  `user_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
-- Table structure for table `home_financialmodal`
--

CREATE TABLE `home_financialmodal` (
  `id` int(11) NOT NULL,
  `title` varchar(512) NOT NULL,
  `day0` varchar(100) NOT NULL,
  `year1` varchar(100) NOT NULL,
  `year2` varchar(100) NOT NULL,
  `year3` varchar(100) NOT NULL,
  `year4` varchar(100) NOT NULL,
  `year5` varchar(100) NOT NULL,
  `property_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
-- Table structure for table `home_individualkyc`
--

CREATE TABLE `home_individualkyc` (
  `id` int(11) NOT NULL,
...
--
-- Table structure for table `home_processflow`
--

CREATE TABLE `home_processflow` (
  `id` int(11) NOT NULL,
...
CREATE TABLE `home_profile` (
  ...
  `doc_proof` varchar(100) NOT NULL,
  `user_id` int(11) NOT NULL,
  `us_resident` tinyint(1) NOT NULL,
  `ownership_type` varchar(20) NOT NULL,
  `us_citizen` varchar(30) NOT NULL,
  `accreditation` varchar(30) NOT NULL,
  `custodial_account` varchar(30) NOT NULL,
  `ssn_taxid` varchar(30) NOT NULL,
  `investment_experience` varchar(30) NOT NULL,
  `previously_invested` varchar(30) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
-- Table structure for table `home_property`
--

CREATE TABLE `home_property` (
  `id` int(11) NOT NULL,
  `name` varchar(100) NOT NULL,
  ...
  `halls` varchar(100) NOT NULL,
  `kitchens` varchar(100) NOT NULL,
  ...
  `about_builder` varchar(512) NOT NULL,
  `financial` varchar(512) NOT NULL,
  `due_diligence` varchar(512) NOT NULL,
  `property_details` varchar(512) NOT NULL,
  `updates` varchar(512) NOT NULL,
  `doc_reports` varchar(512) NOT NULL,
  `location` varchar(512) NOT NULL,
  `map_location` varchar(512) NOT NULL,
  `location_detail` varchar(1024) NOT NULL,
  `localty` varchar(100) NOT NULL,
  `storeys` varchar(100) NOT NULL,
  `parking` varchar(100) NOT NULL,
  `floor_for_sale` varchar(100) NOT NULL,
  `parking_ratio` varchar(100) NOT NULL,
  `floor_efficiency` varchar(100) NOT NULL,
  `fit_outs` varchar(100) NOT NULL,
  `total_area` varchar(100) NOT NULL,
  `power_area` varchar(100) NOT NULL,
  `power_backup` varchar(100) NOT NULL,
  `area_of_sale` varchar(100) NOT NULL,
  `air_conditioning` varchar(100) NOT NULL,
  `purchase_price` varchar(100) NOT NULL,
  `stamp_duty` varchar(100) NOT NULL,
  `brokerage` varchar(100) NOT NULL,
  `legal_fees` varchar(100) NOT NULL,
  `reserves` varchar(100) NOT NULL,
  `highlights` varchar(1000) NOT NULL,
  `featured_image10` varchar(100) DEFAULT NULL,
  `featured_image2` varchar(100) DEFAULT NULL,
  `featured_image3` varchar(100) DEFAULT NULL,
  `featured_image4` varchar(100) DEFAULT NULL,
  `featured_image5` varchar(100) DEFAULT NULL,
  `featured_image6` varchar(100) DEFAULT NULL,
  `featured_image7` varchar(100) DEFAULT NULL,
  `featured_image8` varchar(100) DEFAULT NULL,
  `featured_image9` varchar(100) DEFAULT NULL,
  `financial_desclaimer` varchar(1000) NOT NULL,
  `acquisition` varchar(100) NOT NULL,
  `acquisition_frequency` varchar(100) NOT NULL,
  `asset_management` varchar(100) NOT NULL,
  `asset_management_frequency` varchar(100) NOT NULL,
  `asset_risk` varchar(100) NOT NULL,
  `asset_type` varchar(100) NOT NULL,
  `expected_holding_period` varchar(100) NOT NULL,
  `expected_irr` varchar(100) NOT NULL,
  `funded_member` varchar(100) NOT NULL,
  `minimum_investment` varchar(100) NOT NULL,
  `total_deal_size` varchar(100) NOT NULL,
  `total_sft` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
-- Table structure for table `home_prospectusdocument`
--

CREATE TABLE `home_prospectusdocument` (
  `id` int(11) NOT NULL,
  `title` varchar(512) NOT NULL,
  `document` varchar(100) NOT NULL,
  `property_id` int(11) NOT NULL
...
CREATE TABLE `home_sponsor` (
  ...
  `description` longtext NOT NULL,
  `property_id` int(11) NOT NULL,
  `application_detail` longtext NOT NULL,
  `application_name` varchar(100) NOT NULL,
  `application_overview` longtext NOT NULL,
  `document` varchar(100) NOT NULL,
  `experience_description` longtext NOT NULL,
  `experience_tag` varchar(100) NOT NULL,
  `experience_title` varchar(512) NOT NULL,
...
ALTER TABLE `home_comment`
  ADD PRIMARY KEY (`id`),
  ADD KEY `home_comment_property_id_b5fad27b_fk_home_property_id` (`property_id`);

--
-- Indexes for table `home_companykyc`
--
ALTER TABLE `home_companykyc`
  ADD PRIMARY KEY (`id`),
  ADD KEY `home_companykyc_user_id_090e09f1_fk_auth_user_id` (`user_id`);
...
ALTER TABLE `home_document`
  ADD PRIMARY KEY (`id`),
  ADD KEY `home_document_property_id_41d35f81_fk_home_property_id` (`property_id`);
...
--
-- Indexes for table `home_financialmodal`
--
ALTER TABLE `home_financialmodal`
  ADD PRIMARY KEY (`id`),
  ADD KEY `home_financialmodal_property_id_5e6e8dd8_fk_home_property_id` (`property_id`);

--
-- Indexes for table `home_individualkyc`
--
ALTER TABLE `home_individualkyc`
  ADD PRIMARY KEY (`id`),
  ADD KEY `home_individualkyc_user_id_bc8a9157_fk_auth_user_id` (`user_id`);

--
-- Indexes for table `home_processflow`
--
ALTER TABLE `home_processflow`
  ADD PRIMARY KEY (`id`),
  ADD KEY `home_processflow_user_id_e74c20ab_fk_auth_user_id` (`user_id`);
...
--
-- Indexes for table `home_property`
--
ALTER TABLE `home_property`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `home_prospectusdocument`
--
ALTER TABLE `home_prospectusdocument`
  ADD PRIMARY KEY (`id`),
  ADD KEY `home_prospectusdocument_property_id_063bda2d_fk_home_property_id` (`property_id`);
...
ALTER TABLE `home_sponsor`
  ADD PRIMARY KEY (`id`),
  ADD KEY `home_sponsor_property_id_d91809b7_fk_home_property_id` (`property_id`);
...
--
-- AUTO_INCREMENT for table `home_companykyc`
--
ALTER TABLE `home_companykyc`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `home_financialmodal`
--
ALTER TABLE `home_financialmodal`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `home_individualkyc`
--
ALTER TABLE `home_individualkyc`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `home_processflow`
--
ALTER TABLE `home_processflow`
...
--
-- AUTO_INCREMENT for table `home_property`
--
ALTER TABLE `home_property`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `home_prospectusdocument`
--
ALTER TABLE `home_prospectusdocument`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `home_comment`
  ADD CONSTRAINT `home_comment_property_id_b5fad27b_fk_home_property_id` FOREIGN KEY (`property_id`) REFERENCES `home_property` (`id`);

--
-- Constraints for table `home_companykyc`
--
ALTER TABLE `home_companykyc`
  ADD CONSTRAINT `home_companykyc_user_id_090e09f1_fk_auth_user_id` FOREIGN KEY (`user_id`) REFERENCES `auth_user` (`id`);

--
-- Constraints for table `home_document`
--
ALTER TABLE `home_document`
  ADD CONSTRAINT `home_document_property_id_41d35f81_fk_home_property_id` FOREIGN KEY (`property_id`) REFERENCES `home_property` (`id`);

--
-- Constraints for table `home_financialmodal`
--
ALTER TABLE `home_financialmodal`
  ADD CONSTRAINT `home_financialmodal_property_id_5e6e8dd8_fk_home_property_id` FOREIGN KEY (`property_id`) REFERENCES `home_property` (`id`);

--
-- Constraints for table `home_individualkyc`
--
ALTER TABLE `home_individualkyc`
  ADD CONSTRAINT `home_individualkyc_user_id_bc8a9157_fk_auth_user_id` FOREIGN KEY (`user_id`) REFERENCES `auth_user` (`id`);

--
-- Constraints for table `home_processflow`
--
ALTER TABLE `home_processflow`
  ADD CONSTRAINT `home_processflow_user_id_e74c20ab_fk_auth_user_id` FOREIGN KEY (`user_id`) REFERENCES `auth_user` (`id`);
...
--
-- Constraints for table `home_prospectusdocument`
--
ALTER TABLE `home_prospectusdocument`
  ADD CONSTRAINT `home_prospectusdocument_property_id_063bda2d_fk_home_property_id` FOREIGN KEY (`property_id`) REFERENCES `home_property` (`id`);

--
-- Constraints for table `home_sponsor`
--
ALTER TABLE `home_sponsor`
  ADD CONSTRAINT `home_sponsor_property_id_d91809b7_fk_home_property_id` FOREIGN KEY (`property_id`) REFERENCES `home_property` (`id`);
