...
ALLOWED_HOSTS = ['propfrac.com','3.15.33.110','54.243.184.154','localhost', '127.0.0.1','3.16.41.82', 'propfraction.com','54.160.185.74']
...
DATABASES = {
    'default': {
        ...
        'PASSWORD': 'admin', #for live 'admin' and for local ''
